...
export class ReviewDialog implements OnInit, OnDestroy {

    constructor(private dialog: MatDialogRef<ReviewDialog>, @Inject(MAT_DIALOG_DATA) private data: any, private toast: ToastService, private service: ReviewsService, private formerror: FormErrorService) {};

...
export class VerifyAccountPage implements OnInit, OnDestroy {
    ...
    constructor(private route: ActivatedRoute, private toast: ToastService, private router: Router, private history: HistoryService, private service: AccountService, private formerror: FormErrorService) {};

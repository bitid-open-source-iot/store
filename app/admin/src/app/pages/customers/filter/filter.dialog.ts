...
@Component({
    selector: 'customers-filter-dialog',
    styleUrls: ['./filter.dialog.scss'],
    templateUrl: './filter.dialog.html',
    encapsulation: ViewEncapsulation.None
})

export class CustomersFilterDialog implements OnInit, OnDestroy {

    constructor(private dialog: MatDialogRef<CustomersFilterDialog>, @Inject(MAT_DIALOG_DATA) public config, public stores: StoresService, private formerror: FormErrorService) { }

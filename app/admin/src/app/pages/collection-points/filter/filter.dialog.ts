...
@Component({
    selector: 'collection-points-filter-dialog',
    styleUrls: ['./filter.dialog.scss'],
    templateUrl: './filter.dialog.html',
    encapsulation: ViewEncapsulation.None
})

export class CollectionPointsFilterDialog implements OnInit, OnDestroy {

    constructor(private dialog: MatDialogRef<CollectionPointsFilterDialog>, @Inject(MAT_DIALOG_DATA) public config, public stores: StoresService, private formerror: FormErrorService) { }

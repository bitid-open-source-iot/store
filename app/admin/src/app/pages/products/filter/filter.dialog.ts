...
@Component({
    selector: 'products-filter-dialog',
    styleUrls: ['./filter.dialog.scss'],
    templateUrl: './filter.dialog.html',
    encapsulation: ViewEncapsulation.None
})

export class ProductsFilterDialog implements OnInit, OnDestroy {

    constructor(private dialog: MatDialogRef<ProductsFilterDialog>, @Inject(MAT_DIALOG_DATA) public config, public stores: StoresService, private formerror: FormErrorService) { }

...
@Component({
    selector: 'couriers-filter-dialog',
    styleUrls: ['./filter.dialog.scss'],
    templateUrl: './filter.dialog.html',
    encapsulation: ViewEncapsulation.None
})

export class CouriersFilterDialog implements OnInit, OnDestroy {

    constructor(private dialog: MatDialogRef<CouriersFilterDialog>, @Inject(MAT_DIALOG_DATA) public config, public stores: StoresService, private formerror: FormErrorService) { }

...
@Component({
    selector: 'departments-filter-dialog',
    styleUrls: ['./filter.dialog.scss'],
    templateUrl: './filter.dialog.html',
    encapsulation: ViewEncapsulation.None
})

export class DepartmentsFilterDialog implements OnInit, OnDestroy {

    constructor(private dialog: MatDialogRef<DepartmentsFilterDialog>, @Inject(MAT_DIALOG_DATA) public config, public stores: StoresService, private formerror: FormErrorService) { }

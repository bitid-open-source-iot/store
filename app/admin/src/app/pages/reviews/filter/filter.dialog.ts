...
@Component({
    selector: 'reviews-filter-dialog',
    styleUrls: ['./filter.dialog.scss'],
    templateUrl: './filter.dialog.html',
    encapsulation: ViewEncapsulation.None
})

export class ReviewsFilterDialog implements OnInit, OnDestroy {

    constructor(private dialog: MatDialogRef<ReviewsFilterDialog>, @Inject(MAT_DIALOG_DATA) public config, public stores: StoresService, private formerror: FormErrorService) { }

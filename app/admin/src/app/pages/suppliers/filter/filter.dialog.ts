...
@Component({
    selector: 'suppliers-filter-dialog',
    styleUrls: ['./filter.dialog.scss'],
    templateUrl: './filter.dialog.html',
    encapsulation: ViewEncapsulation.None
})

export class SuppliersFilterDialog implements OnInit, OnDestroy {

    constructor(private dialog: MatDialogRef<SuppliersFilterDialog>, @Inject(MAT_DIALOG_DATA) public config, public stores: StoresService, private formerror: FormErrorService) { }

	...
	var responder = {
		...
		model: (req, result) => {
			...
			switch (req.originalUrl) {
				...
				case ('/store/warnings/add'):
					responder.response.warnings.add(result).then(deferred.resolve, deferred.reject);
					break;
				case ('/store/warnings/get'):
					responder.response.warnings.get(result).then(deferred.resolve, deferred.reject);
					break;
				case ('/store/warnings/list'):
					responder.response.warnings.list(result).then(deferred.resolve, deferred.reject);
					break;
				...
				case ('/store/products/share'):
				case ('/store/warnings/share'):
				case ('/store/reviews/approve'):
				case ('/store/products/update'):
				case ('/store/warnings/update'):
				case ('/store/couriers/share'):
				case ('/store/couriers/update'):
				case ('/store/suppliers/share'):
				case ('/store/apis/unsubscribe'):
				case ('/store/suppliers/update'):
				case ('/store/wishlists/update'):
				case ('/store/addresses/update'):
				case ('/store/departments/share'):
				case ('/store/stores/unsubscribe'):
				case ('/store/departments/update'):
				case ('/store/products/unsubscribe'):
				case ('/store/warnings/unsubscribe'):
				case ('/store/couriers/unsubscribe'):
				case ('/store/apis/updatesubscriber'):
				case ('/store/orders/update/address'):
				case ('/store/orders/update/payment'):
				case ('/store/suppliers/unsubscribe'):
				case ('/store/collectionpoints/share'):
				case ('/store/stores/updatesubscriber'):
				case ('/store/collectionpoints/update'):
				case ('/store/departments/unsubscribe'):
				case ('/store/products/updatesubscriber'):
				case ('/store/warnings/updatesubscriber'):
				case ('/store/couriers/updatesubscriber'):
				case ('/store/suppliers/updatesubscriber'):
				case ('/store/collectionpoints/unsubscribe'):
				case ('/store/departments/updatesubscriber'):
				case ('/store/collectionpoints/updatesubscriber'):
				...
				case ('/store/collectionpoints/delete'):
